...
object Variables {
    ...
    val blue3: Color = Color(0xFF163688)

    val orange1: Color = Color(0xFFFE9C65)
    val orange2: Color = Color(0xFFDA763F)
    val orange3: Color = Color(0xFFBF4E0F)

    val purple1: Color = Color(0xFFC361FF)
    val purple2: Color = Color(0xFF9E37DD)
    val purple3: Color = Color(0xFF600796)

    val grey1: Color = Color(0xFFEBECEF)
    val grey2: Color = Color(0xFFABB0BF)
    val grey3: Color = Color(0xFF6A7598)
